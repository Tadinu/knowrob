...
namespace knowrob::py {
	...
	struct AtomicWrap : public Atomic {
		explicit AtomicWrap(AtomicType atomicType) : Atomic(atomicType) {}

		std::string_view stringForm() const override { return std::string_view(); }
